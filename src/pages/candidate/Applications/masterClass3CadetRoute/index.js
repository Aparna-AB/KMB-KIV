...
const Index = () => {
  ...
  return (
    <Container>
      <Row>
        <h2 className="mb-4 ">Master Class 3 - Cadet Route</h2>
      </Row>
      <div className="card">
        <div className="container card-container">
          <div className="row headrow">
            <div className="col-md-12">
              ...
              <h4>
                Application for Certificate of Competency to act as Master Class
                3 or Serang for new entrants
                <br /> through cadet training route
              </h4>
            </div>
          </div>
          {form1 && (
