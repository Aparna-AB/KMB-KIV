  ...
  return (
    <Container className="master-class-form">
      ...
      <p className="sub-head">
        Every candidate for certification as Master Class 2 shall be:
      </p>
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">1) A Citizen of India</p>
        </Col>
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            2) Not less than twenty one years of age
          </p>
        </Col>
        <Col xs={12} sm={12} md={5} lg={5} xl={5} xxl={5}>
          <TextBox type="file"></TextBox>
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            {" "}
            3) Medically fit and produce a medical certificate as to his
            physical fitness in Form No. 1 appended to these rules from an
            Inland Waterways Authority of India or Designated Authority
            empanelled MBBS Medical Practitioner or medical officer of district
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            ...
            Class 3 or Serang, which shall be an approved course by the
            competent authority and the minimum course duration, contents and
            the structure of the Preparatory Course for Master Class 3 or Serang
            shall be as per the training programmes approved by the competent
            authority and notified form of guidelines or circulars; from time to
            time, shall have minimum service of 36 months on inland vessels
          </p>
        </Col>
        <Col xs={12} sm={12} md={5} lg={5} xl={5} xxl={5}>
          <TextBox type="file"></TextBox>
