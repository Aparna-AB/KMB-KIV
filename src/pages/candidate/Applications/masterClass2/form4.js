  ...
  return (
    <Container className="master-class-form">
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            1) Be in possession of valid Master Class 3 or Serang Certificate of
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            2) Have a minimum service of 36 months out of which 12 months shall
            be as Serang
          </p>
        </Col>
        <Col xs={12} sm={12} md={5} lg={5} xl={5} xxl={5}>
      ...
      <Row className="mb-4 align-items-center">
        <Col xs={12} sm={12} md={7} lg={7} xl={7} xxl={7}>
          <p className="file-upload-tag">
            ...
            Class 2, which shall be an approved course by the competent
            authority and the minimum course duration, contents and the
            structure of the Preparatory Course for Master Class 2 shall be as
