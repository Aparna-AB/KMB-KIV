...
import ApprovalForm from "./components/createUser";
// import "./styles.scss";
...
const Index = () => {
  ...
  const tableColumns = [
    ...
    { heading: "User Name", value: "ref_num", type: "row" },
    { heading: "Role", value: "v_name", type: "row" },
    { heading: "Status", value: "v_name", type: "row" },
      ...
      <div className="card">
        <div className="container card-container">
          ...
          <div className="row">
            ...
            <div className="col-md-3 view-button-container" >
            <Button label={"Create User"} className={"add-new-btn"} onClick={handleViewClick}></Button>
