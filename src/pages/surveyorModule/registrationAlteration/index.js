...
import RegistartionAlteration from "./components/registartionAlterationView";
import "./style.scss";
...
const Index = () => {
  ...
  return (
    <Container>
      ...
      {showCertificate && (
        <RegistartionAlteration
          show={showCertificate}
          handleClose={handleCloseCertificate}
        />
      )}
      <h2>Registration of alteration</h2>
